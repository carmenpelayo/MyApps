...
def comparator():
    ...
    st.write(
        """
        - A score of 0 represents the mean score of the regions.A score of -1 represents the region is in the lower 15.9% of the regions. Lower scores correspond to left outliers.
